...
ImageName21='AAL116_1mm';
ImageName2=[ImageName21,'.nii'];
...
for i=1:1:3
    ...
    axis off;
    axis vis3d;
    trisurf(T2.faces,T2.vertices(:,2),T2.vertices(:,1),T2.vertices(:,3),'FaceColor',[0.8,0.2,0.2],'LineStyle',lineStyle,'FaceAlpha',faceTrans,'EdgeColor',edgeColor,'LineWidth',0.1);
    view(allView(i,:));
    hlight=camlight('right');
    saveas(gcf,['ChongqingTract\',ImageName21,'_',dec2base(i,10,2),'.png']);
end
